...
module.exports = {
  ...
  sendInBlue: async function (config) {
    try{
      const data = await new SibApiV3Sdk.TransactionalSMSApi(
        {
          "sender": "2347060942709",
          "recipient":"2347060942709",
          "content":"test content right here",
        }
      )
