...
module.exports = function (entity, pageName, success, error, baseUrl) {
  ...
  this._list = [];
  this._column = ['ID', 'Photo', 'Email', 'Name', 'Joined At', 'Action'];
  this._readable_column = ['ID', 'Email', 'Joined At'];
  // this._column = ['ID','Photo','Email','Name','Status','Joined At','Action'];
  // this._readable_column = ["ID","Email","Status","Joined At"];
  this._entity = entity;
  this._heading = 'Users';
  ...
  this._page;
  this._num_links = 5;
  this._field_column = ['id', 'photo', 'email', '', 'created_at'];
  this._readable_field_column = ['id', 'email', 'created_at'];
  // this._field_column = ['id', 'photo', 'email', '', 'status', 'created_at'];
  // this._readable_field_column = ['id', 'email', 'status', 'created_at'];
  this._links = '';
  this._sort_base_url = '';
  this._order_by = '';
  this._sort = '';
  ...
  this.get_verify = function () {
    return this._verify;
  };

  this.set_verify = function (verify) {
    this._verify = verify;
  };
  ...
  this.to_json = function () {
    ...
    for (let key in list) {
      ...
      list[key].two_factor_authentication =
        this.two_factor_authentication_mapping()[
          value.two_factor_authentication
        ];
      let clean_list_entry = {};
      clean_list_entry['id'] = value['id'];
      clean_list_entry['photo'] = value['photo'];
      clean_list_entry['email'] = value['email'];
      // clean_list_entry['status'] = value['status'];
      clean_list_entry['created_at'] = value['created_at'];
