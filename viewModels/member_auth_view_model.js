...
module.exports = function (entity, pageName = '', success, error) {
  ...
  this.account_exists = function (email, otherFields={}) {
    return db.user.getByFields({ email, status: 1, ...otherFields });
  };
  ...
  this.destroy_user = function (id) {
    return this.entity.realDelete(id);
  };
  ...
  this.saveTokenToDB = function (
    ...
    return db.token.insert({ token, user_id, issue_at, expire_at, type: 3, });
  };
  ...
  this.status_mapping = function () {
    return this.entity.status_mapping();
  };
  this.role_id_mapping = function () {
    return this.entity.role_id_mapping();
  };

  this.type_mapping = function () {
    return this.entity.type_mapping();
  };

  this.verify_mapping = function () {
    return this.entity.verify_mapping();
  };

  this.two_factor_authentication_mapping = function () {
    return this.entity.two_factor_authentication_mapping();
  };

  this.force_password_change_mapping = function () {
    return this.entity.force_password_change_mapping();
  };
